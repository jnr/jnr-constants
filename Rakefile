...
if (IS_WINDOWS)
  CONSTANTS = ['LastError', 'Errno', 'OpenFlags', 'Signal', 'AddressFamily', 'ProtocolFamily', 'IPProto', 'SocketMessage', 'SocketLevel', 'Sock', 'SocketOption', 'InterfaceInfo', 'ErrnoAddressInfo', 'AddressInfo', 'Inet', 'Inet6', 'IP', 'TCP', 'IPv6']
else
