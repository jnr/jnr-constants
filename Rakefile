...
if (IS_WINDOWS)
  CONSTANTS = ['LastError', 'Errno', 'OpenFlags', 'Signal', 'AddressFamily', 'ProtocolFamily', 'IPProto', 'SocketMessage', 'SocketLevel', 'Sock', 'SocketOptions', 'InterfaceInfo', 'ErrnoAddressInfo', 'AddressInfo']
else
